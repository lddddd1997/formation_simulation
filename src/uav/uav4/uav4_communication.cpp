...
{
    ros::init(argc, argv, "formation_uav4_communication");
    ros::NodeHandle nh("~");
    ...
    ros::Publisher commnication_pub = nh.advertise<formation_simulation::communication>("/uav4_sim/uav4_communication/pos_vel/local", 10);
    ...
    cout<<"uav4 communication node started!!!"<<endl;
    while(ros::ok())
    {
        //执行回调函数
        ros::spinOnce();
