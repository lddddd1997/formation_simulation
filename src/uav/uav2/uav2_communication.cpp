...
{
    ros::init(argc, argv, "formation_uav2_communication");
    ros::NodeHandle nh("~");
    ...
    ros::Publisher commnication_pub = nh.advertise<formation_simulation::communication>("/uav2_sim/uav2_communication/pos_vel/local", 10);
    ...
    cout<<"uav2 communication node started!!!"<<endl;
    while(ros::ok())
    {
        //执行回调函数
        ros::spinOnce();
