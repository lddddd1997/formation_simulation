...
{
    ros::init(argc, argv, "formation_uav3_communication");
    ros::NodeHandle nh("~");
    ...
    ros::Publisher commnication_pub = nh.advertise<formation_simulation::communication>("/uav3_sim/uav3_communication/pos_vel/local", 10);
    ...
    cout<<"uav3 communication node started!!!"<<endl;
    while(ros::ok())
    {
        //执行回调函数
        ros::spinOnce();
